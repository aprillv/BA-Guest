...
@interface mainmenuaaa : fathercontroller<UITableViewDataSource, UITableViewDelegate>{
...
@property (nonatomic, retain) NSString *idmastercia;
@property (nonatomic, retain) NSString *mastercianm;
