...
-(void)doInitPage{
    ...
    UIScrollView *v3=[[UIScrollView alloc]initWithFrame:CGRectMake(0, 160, xw, xh-205)];
    ...
    [btn1 setFrame:CGRectMake(xx, y,250, 44)];
    [btn1 setTitle:@"Send" forState:UIControlStateNormal];
    [btn1 addTarget:self action:@selector(doSend:) forControlEvents:UIControlEventTouchDown];
    [sv addSubview:btn1];
    
    btn1 = [bc getButton:[UIColor grayColor] andrect:CGRectMake(0, 0, 150, 44)];
    [btn1 setFrame:CGRectMake(xx+294, y,250, 44)];
